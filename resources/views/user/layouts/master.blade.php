                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            ...
                            <div class="dropdown d-inline me-5">
                                ...
                                <ul class="dropdown-menu">
                                  <li class="my-2"><a class="dropdown-item" href="{{route('user#accountchangepage')}}">
                                    <i class="fa-solid fa-user"></i>Account
                                    </a>
                                </li>
                                  <li class="my-2"><a class="dropdown-item" href="{{route('user#changepasswordpage')}}">
                                  ...
                                  <li class="my-2">
                                    <form action="{{ route('logout') }}" method="POST" class="d-inline">
                                        ...
                                        <button class="btn bg-dark text-white"><i
                                                class="fa-solid fa-arrow-right-from-bracket "></i><span class="ms-3">Logout</span>
                                        </button>
