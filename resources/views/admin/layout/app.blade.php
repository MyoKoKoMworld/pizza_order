...
<head>
    ...
    {{-- fontawesome link --}}
    <script src="https://kit.fontawesome.com/88063fc124.js" crossorigin="anonymous"></script>
    <!-- Main CSS-->
                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="{{route('product#list')}}">
                                <i class="fa-solid fa-pizza-slice"></i>Product List</a>
                        </li>
                        <li>
                            <a href="{{route('admin#order')}}">
                                <i class="fa-solid fa-list-check"></i></i>Order List</a>
                        </li>
                    </ul>
                </nav>
            </div>
                                            ...
                                            <div class="account-dropdown__body">
                                                <div class="account-dropdown__item">
                                                    <a href="{{route('admin#changePasswordPage')}}">
                                                        <i class="fa-light fa-key"></i>Change Password</a>
                                                </div>
                                            </div>
                                            <div class="account-dropdown__body" >
